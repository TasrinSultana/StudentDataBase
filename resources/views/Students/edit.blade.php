...
@section('page-content')
    ...
    <form method="post" action="{{route('students.update',$student)}}">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="dept" class="form-control @error('dept') is-invalid @enderror" value="{{old('dept', $student->dept)}}" id="dept" name="dept" placeholder="Department">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="address" class="form-control @error('address') is-invalid @enderror" value="{{old('address', $student->address)}}" id="address" name="address" placeholder="Address">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="phone" class="form-control @error('phone') is-invalid @enderror" value="{{old('phone', $student->phone)}}" id="phone" name="phone" placeholder="Phone">
